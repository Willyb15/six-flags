			...
			<div class="admin-wrapper col-sm-6 col-sm-offset-3">
				<form action="admin_process.php" method="post">
				  ...
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" name="body_text" id="field4" placeholder="Enter Body Text">
				  </div>
				  <div class="form-group">
				    <label for="field5">Lower Image</label>
				    <input type="text" name="lower_image" class="form-control" id="field5" placeholder="Enter Path to Lower Image Text">
				  </div>
